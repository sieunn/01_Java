...
public class PropTest {
	...
	public static void fileOpen(Properties p) {
		try {
			...
			//정렬을 할 때는 정렬하는 기준
			//		정렬할때는 이름이면 이름, 년도별, 몇부작인지 정렬하는 기준이 있음
			//	담겨있는 드라마들을 다시 정렬하겟다. 정렬하는 기준 Drama[0] = name이다.
